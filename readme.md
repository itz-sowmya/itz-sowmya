<h2> <img src="https://media1.giphy.com/media/MPxg9U887PS0B8XT4J/giphy.gif" width="30" height="30"> &nbsp; I'm Sowmya Nagaraj! </h2>
<img align='left' src="https://github.com/govardhan-srinivas/govardhan-srinivas/blob/master/coding.gif?raw=true" width="230">
<p><em> &nbsp; Scrum master</br> &nbsp; Spending most of the time on learning Azure DevOps and SCRUM cermonies and principles.</em></p>
...
const sowmya = {
  pronouns: "she" | "her",
  skills: [Agile Methodologies, Scrum practices, Facilitation, Conflict resolution, Leadership, Project management],
  tools: [JIRA, Azure Devps(Formerly TFS), Trello]
}
```
